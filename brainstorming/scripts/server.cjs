...
<body><!-- BRANDING --><h1>Brainstorming Companion</h1>
<p>等待 agent 推送新的画面...</p></body></html>`);
}

const FORBIDDEN_PAGE = `<!DOCTYPE html>
<html>
<head><meta charset="utf-8"><title>需要 session key</title>
<style>body { font-family: system-ui, sans-serif; padding: 2rem; max-width: 800px; margin: 0 auto; }
h1 { color: #333; } p { color: #666; } code { background: #f0f0f0; padding: 0.1em 0.3em; border-radius: 4px; }</style>
</head>
<body><h1>需要 session key</h1>
<p>这个页面需要 coding agent 提供的完整 URL，包括
...
function bootstrapPage(key) {
  ...
  return `<!DOCTYPE html>
<html>
<head><meta charset="utf-8"><title>Opening Brainstorming Companion</title></head>
<body>
<script>
